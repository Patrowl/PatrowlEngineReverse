...
class TestEngine(unittest.TestCase):
    ...
    def test_do_advanced_whois(self):
        options = {
            'assets': [
                {"datatype": "domain", "value": 'yohangastoud.fr'}
            ],
    ...
    def test_do_seg_check_seg_dict(self):
        ...
        self.assertEqual(len(results), 1)
        self.assertEqual(results[0]['result']['type'], "seg_check")
        self.assertEqual(results[0]['result']['title'], "Secure Email Gateway found: Microsoft/Microsoft 365 Defender Overview")
    ...
    def test_do_dkim_check(self):
        ...
        self.assertEqual(results[0]['result']['title'], "DKIM check for 'yohangastoud.fr' (HASH: 58664d)")
    ...
    def test_do_dmarc_check(self):
        ...
        self.assertEqual(results[0]['result']['title'], "DMARC for 'yohangastoud.fr' (HASH: 3938e6)")
