...
MALFORMED_SPF_RECORD = {
    ...
    "description": "SPF record can be malformed and not be understood by mail servers: extra space before or after "
                   "SPF record, surrounded by quotation marks, illegal mechanisms, etc.",
    "solution": "Change SPF resource to respect best practices."
}
...
MISS_SPF_RECORD_TERMINATION = {
    ...
    "solution": "Review your SPF record to conclude with either an 'all' mechanism or a 'redirect' modifier."
}

# An SPF record has been set
SPF_RECORD_SET = {
    "severity": "info",
    "confidence": "certain",
    "title": "SPF record is set",
    "description": "An SPF record has been set.",
    "solution": ""
}
